  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Explore Hoshi Vault’s curated portfolio of premium domains for lease or sale." />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Premium Domain Names for Brands | Hoshi Vault" />
        <meta property="og:description" content="Discover high-value domains across finance, health, AI and more. Lease or buy securely via escrow." />
      </Head>
      <section style={{ padding: 'var(--space-6) 0', background: 'var(--color-neutral)', textAlign: 'center' }}>
        <div className="container">
          <h1 style={{ marginBottom: 'var(--space-3)' }}>Unlock Premium Domains for Extraordinary Brands</h1>
          <p style={{ marginBottom: 'var(--space-4)' }}>Hoshi Vault curates the world’s finest digital real estate — short, memorable names ready to power your next venture.</p>
          <div style={{ display: 'flex', justifyContent: 'center', gap: 'var(--space-3)', flexWrap: 'wrap' }}>
            <Link href="/portfolio"><a style={{ background: 'var(--color-accent-primary)', color: '#fff', padding: 'var(--space-2) var(--space-3)', borderRadius: 'var(--radius)' }}>Explore Portfolio</a></Link>
            <Link href="/leasing"><a style={{ border: '1px solid var(--color-accent-primary)', color: 'var(--color-accent-primary)', padding: 'var(--space-2) var(--space-3)', borderRadius: 'var(--radius)' }}>Lease a Domain</a></Link>
          </div>
        </div>
      </section>
      ...
      <section style={{ padding: 'var(--space-5) 0', background: 'var(--color-neutral)' }}>
        <div className="container" style={{ textAlign: 'center' }}>
          ...
          <p style={{ marginBottom: 'var(--space-3)' }}>Selected Deployments: Healthcare, Fintech, AI, Geo markets and more.</p>
          <form onSubmit={(e) => { e.preventDefault(); alert('Shortlist request submitted'); }} style={{ display: 'grid', gap: 'var(--space-3)', maxWidth: '600px', margin: '0 auto' }}>
            ...
            <button type="submit" style={{ background: 'var(--color-accent-primary)', color: '#fff', padding: 'var(--space-2)', borderRadius: 'var(--radius)', border: 'none' }}>Submit</button>
          </form>
        </div>
      </section>
      <section style={{ padding: 'var(--space-5) 0' }}>
        <div className="container">
          ...
          <p>Hoshi Vault is a private domain asset company specialising in the acquisition, management and strategic deployment of premium digital real estate. Our mission is to maximise asset value through recurring cashflow, selective high-margin exits and long-term equity growth. Whether leasing or buying, clients trust Hoshi Vault for its authority, discretion and premium inventory. All transactions are conducted via independent escrow for safety and trust.</p>
        </div>
      </section>
    </>
  );
